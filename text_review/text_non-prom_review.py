...
####
with open('documents_text_high_resolution\\document_3.txt', 'r', encoding='latin-1') as file:
...
def text_review_5():
    for i in range(5):
        ...
        with open(f"text_review\\non-prom_review\\document_3_output{i + 1}.txt", "w") as f:
