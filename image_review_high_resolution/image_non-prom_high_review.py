...
# Path to your image
image_path = f"documents_jpg_high_resolution\\document_{doc_num}.jpg"
...
def image_review_5():
    for i in range(5):
        ...
        with open(f"image_review_high_resolution\\non-prom_review\\document_{doc_num}_output{i + 1}.txt", "w", encoding="utf-8") as f:
